                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('image/icon.png') }}" alt="homepage" class="light-logo" style="width: 75px; height: auto;"/>
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('image/logo_text.png') }}" alt="homepage" class="light-logo" style="width: 90px; height: auto;" />
               ...
               <div class="scroll-sidebar"> 
                ...
                <nav class="sidebar-nav"> 
                    <ul id="sidebarnav" class="p-t-30"> 
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-book"></i><span class="hide-menu">Data SIPKA </span></a> 
                            <ul aria-expanded="false" class="collapse  first-level"> 
                                <li class="sidebar-item"><a href="icon-material.html" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Laporan Kekerasan </span></a> 
                        </li> 
                                <li class="sidebar-item"><a href="icon-fontawesome.html" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Edukasi </span></a>
                                </li> 
                            </ul> 
                        </li> 
...
table-bordered"> 
            ...
            <footer class="footer text-center">
                SIPKA|"No Cap, Protect the Future."</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
