    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20"><span class="db"></span>
                    <h1>HALO</h1>
                        <img src="{{ asset('image/logo.png') }}" alt="logo" style="width: 300px; height: auto;"/></span>
                    </div>
                    <!-- Form -->
                    <!-- error -->
                ...
                <form class="form-horizontal m-t-20" id="loginform" 
                        action="{{ route('backend.login.process') }}" 
                        method="POST">
                     @csrf
                            ...
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success text-white" id="basic-addon1"><i class="ti-key"></i></span>
                                    </div>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-warning text-white" id="basic-addon2"><i class="ti-car"></i></span>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <button class="btn btn-success float-right" type="submit"><i class="fa fa-lock m-r-5"></i>Login</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Masukan alamat email Anda di bawah ini dan kami akan mengirimkan petunjuk untuk memulihkan password.</span>
                    </div>
                    ...
                    <div id="recoverform">
                        <div class="text-center">
                            <span class="text-white">Masukkan alamat email Anda di bawah ini dan kami akan mengirimkan petunjuk untuk memulihkan password.</span>
                        </div>
                        <div class="row m-t-20">
                            <!-- Form -->
